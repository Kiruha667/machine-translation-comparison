...
def main(args):
    ...
    history_path = os.path.join(SAVE_DIR, 'transformer_history.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=LEARNING_RATE_TRANSFORMER,
                       help=f'Learning rate (default: {LEARNING_RATE_TRANSFORMER})')
